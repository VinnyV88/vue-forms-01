<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <!-- 
      v-model: has modifiers (.number, .trim, .lazy) 
      which will auto convert input to a number, trim trailing/leading spaces,
      and update inputs less frequently
      *** Important - using refs does not allow for this functionality
        -->
    </div>
    <div class="form-control">
